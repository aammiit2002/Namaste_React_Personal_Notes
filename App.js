...
//   const { resData } = props;
//   const { resName, image, cusine } = resData?.data;
//   return (
//     <div className="dish">
  ...
  return (
    <div className="body">
      <div className="search">
        <input type="text" placeholder="Briyani" />
      ...
      <div className="res-container">
        ...
        {/* <Dishcard
          resName="Country Kitchen"
          cusine="Asian"
          image={imgChest[0].kfc}
        />
        <Dishcard
          resName="Kabsa Foods"
          cusine="North Indian"
          image={imgChest[0].kfc}
        />
        <Dishcard resName="KFC" cusine="Western" image={imgChest[0].kfc} />
        <Dishcard resName="Kiva" cusine="Indian" image={imgChest[0].kfc} />
        <Dishcard
          resName="Hurngry Chicken"
          cusine="Western"
          image={imgChest[0].kfc}
        />
        <Dishcard
          resName="Wow Momo"
          cusine="Chinese"
          image={imgChest[3].wow_momo}
        />
        <Dishcard
          resName="Wow China"
          cusine="Chinese"
          image={imgChest[2].wow_china}
        />
        <Dishcard
          resName="Burger King"
          cusine="Western"
          image={imgChest[1].burger_king}
        />
        <Dishcard
          resName="Adda"
        ...
        />
        <Dishcard
          resName="Indian Chicken Express"
          cusine="western, Chinese"
          image={imgChest[0].kfc}
        /> */}
      </div>
    </div>
